...
/*                 #about.address {
	...
	<div style="padding-left:50px;font-size:30px; background-color:#424242;color:white;margin:0 0 20px 0;">Provider Information
               ...
               <div style="display:inline-flex;">
		         <div style="border: 1px solid black;padding:50px;border-radius:25px;margin:0 85px 0 20px;">
                ...
                <div style="border: 1px solid black;margin:0 85px 0 20px;padding:40px;border-radius:25px;">
                ...
                <div>
           <h:commandButton action="Search_final" value="BACK" styleClass="button-style"/>
                </div>
			</div>
			</center>
		</h:form>

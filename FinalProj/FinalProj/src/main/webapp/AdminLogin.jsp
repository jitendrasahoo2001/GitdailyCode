                        ...
                        <div class="login100-form validate-form">
                            ...
                            <div class="wrap-input100 validate-input m-b-23" data-validate="Password is required">
                                ...
                                <div class="icon">
                                    ...
                                    <i class="fa fa-eye" id="showPassSlash" style="display: none;"></i>
                                </div>
                                <div id="passInput">
                            ...
                            <div class="text-right p-t-8 p-b-31">
                                <a href="PatientForgotPassword.jsp">Forgot password?</a>
                            </div>
                            <div class="container-login100-form-btn">
                                <div class="wrap-login100-form-btn">
                                    <div class="login100-form-bgbtn"></div>
                                    <h:commandButton action="#{adminController.adminLoginValidate()}" value="Login" style="height: 35px;
                                        outline: none;
                                        border: none;
                                        position: relative;
                            ...
                            <div class="text-right p-t-8 p-b-31" style="position: relative;
    top: 29px;">
                                <a href="SignInAdmin.jsp">Don't have an account? Sign In.</a>
                            </div>
                        </div>
                    </div>
                </div>
